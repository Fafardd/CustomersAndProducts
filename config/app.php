...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '85ef2a6946764425f6c4c591ff821c84c503200a67ec3c30af1f19052694eb67'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'root',
            'password' => 'mysql',
            'database' => ROOT . DS . 'sqlite' . DS . 'CustomersAndProducts.sqlite',
            /*
        ...
        'test' => [
            ...
            'username' => 'root',
            'password' => 'mysql',
            'database' => ROOT . DS . 'sqlite' . DS . 'CustomersAndProductsTest.sqlite',
            //'encoding' => 'utf8mb4',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
